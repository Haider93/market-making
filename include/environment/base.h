...
class Base
{
    protected:
		...
		float mar_reg;//0-0.5 means bullish, 0.5-1 means neutral, >1 means bearish

        // Agent
        market::tp::TargetPrice* target_price_;
		//market::tp::TargetPrice* future_target_price;//holds midprice of 1 or many future lob states
    ...
    protected:
        ...
        virtual void DoAction(int action, float regime) = 0;
